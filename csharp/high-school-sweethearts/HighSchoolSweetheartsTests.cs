...
";
    ...
    private const string expectedFooBarBanner =
@"
     ******       ******
   **      **   **      **
 **         ** **         **
...
";
    ...
    [Fact]
    [Task(2)]
    public void DisplayFooBarBanner()
    {
        string actualBanner = HighSchoolSweethearts.DisplayBanner("Foo", "Bar");
        Assert.Equal(expectedFooBarBanner.Trim(), actualBanner.Trim());
    }
